...
* __Особенности задачи__:
    ...
    - В качестве нового метода предлагается применить __большие языковые модели__ (БЯМ), что предполагает работу с промпт-инжинирингом и развёртывание моделей локально либо взаимодействие с ними через API.
