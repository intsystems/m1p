...
<!-- ## Задача 140  (???) Утвердить у Бахтеева
...
* __Литература__: 
 	...
 	- [2] [Similarity-based positional encoding for enhanced classification in medical images](https://ceur-ws.org/Vol-3880/paper16.pdf)
* __Базовой алгоритм__: Базовый алгоритм состоит в обучении Unet со вторым слоем position embeddings. Более продвинутый с эмбединговым слоем для относительных координат патча sliding window в нейронной сети.
* __Новизна__: Индустриальная
* __Авторы__: Матвей Крейнин
* __Контакт__: [TG: @kreininmv](https://t.me/kreininmv)
