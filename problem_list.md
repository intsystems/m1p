...
* __Постановка 1:__ ОПараметры обученной генеративной модели содержат информацию о статистике обучающих данных. Предполагается, что различия в весах моделей коррелируют с различиями между датасетами.
