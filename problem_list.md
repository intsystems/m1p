...
* **Авторы:** Александр Владимирович Гасников (и консультант)
...
## Задача 117    (OLD)
* **Название:** Поиск зависимостей биомеханических системах (люди танцуют в паре или независимо?) и (Метод Convergence Cross-Mpping, теорема Такенса)
...
* __Данные__:
	* Акселерометр, гироскоп, и другие данные, описывающие динамические системы 	
* Решение 
...
* **Авторы:** Эксперт Стрижов (было Задача 109), консультант - Тихонов
...
## Задача 125 (OLD, will ask for a new problem)
...
## Задача 134  (OLD ready to submission)
...
## Задача 140 (OLD, will be updated)
